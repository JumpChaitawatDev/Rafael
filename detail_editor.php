             ...
             <div class="tab-pane fade show active" id="Gallery-5-8" role="tabpanel" aria-labelledby="tab-5-8">
                  ...
                  <div class="card-body">
                  	...
                  	<ul class="nav nav-tabs tab-solid tab-solid-warning" role="tablist">
                          <li class="nav-item">
                            <a class="nav-link active" id="tab-g-1" data-toggle="tab" href="#details-g-1" role="tab" aria-controls="details-g-1" aria-selected="true">All</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" id="tab-g-2" data-toggle="tab" href="#details-g-2" role="tab" aria-controls="details-g-2" aria-selected="false">Leaf</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" id="tab-g-3" data-toggle="tab" href="#details-g-3" role="tab" aria-controls="details-g-3" aria-selected="false">Flower</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" id="tab-g-4" data-toggle="tab" href="#details-g-4" role="tab" aria-controls="details-g-4" aria-selected="false">Fruit</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" id="tab-g-5" data-toggle="tab" href="#details-g-5" role="tab" aria-controls="details-g-5" aria-selected="false">Seed</a>
                          </li>
                    ...
                    <div class="tab-content tab-content-solid">
                        ...
                        <div class="tab-pane fade active show" id="details-g-1" role="tabpanel" aria-labelledby="tab-g-1">
		                      ...
		                      <a  class="image-tile">
		                        ...
		                        <a class="image-tile">
		                        <img class="s300x300" src="theme/assets/images/tomato/leaf1.jpg" alt="image small"> </a>
		                      <a class="image-tile">
		                        <img class="s300x300" src="theme/assets/images/tomato/leaf2.jpg" alt="image small"> </a>
		                      <a  class="image-tile">
		                        <img class="s300x300" src="theme/assets/images/tomato/leaf3.jpg" alt="image small"> </a>
		                      <a  class="image-tile">
		                        <img class="s300x300" src="theme/assets/images/tomato/leaf4.jpg" alt="image small"> </a>
		                        <a class="image-tile">
		                        <img class="s300x300" src="theme/assets/images/tomato/flower1.jpg" alt="image small"> </a>
		                        <a class="image-tile">
		                        <img class="s300x300" src="theme/assets/images/tomato/flower2.jpg" alt="image small"> </a>
		                        <a class="image-tile">
		                        <img class="s300x300" src="theme/assets/images/tomato/flower3.jpg" alt="image small"> </a>
		                        <a class="image-tile">
		                        <img class="s300x300" src="theme/assets/images/tomato/flower4.jpg" alt="image small"> </a>
		                        <a class="image-tile">
		                        <img class="s300x300" src="theme/assets/images/tomato/seed1.jpg" alt="image small"> </a>
		                      <a  class="image-tile">
		                        <img class="s300x300" src="theme/assets/images/tomato/seed2.jpg" alt="image small"> </a>
		                      <a  class="image-tile">
		                        <img class="s300x300" src="theme/assets/images/tomato/seed3.jpg" alt="image small"> </a>
		                      <a  class="image-tile">
		                        <img class="s300x300" src="theme/assets/images/tomato/seed4.jpg" alt="image small"> </a>
		                     
                     		</div>
                  		</div>

                  		<div class="tab-pane fade" id="details-g-2" role="tabpanel" aria-labelledby="tab-g-2">
		                      ...
		                      <a  class="image-tile">
		                        <img class="s300x300" src="theme/assets/images/tomato/leaf4.jpg" alt="image small"> </a>
		                      <a  class="image-tile">
		                        <img class="s300x300" src="theme/assets/images/tomato/leaf5.jpg" alt="image small"> </a>

                     		</div>
                  		</div>

                  		<div class="tab-pane fade" id="details-g-3" role="tabpanel" aria-labelledby="tab-g-3">
                          	...
                          	<div id="dragula-left" class="row lightGallery">
		                       ...
		                       <a class="image-tile">
		                        ...
		                        <img class="s300x300" src="theme/assets/images/tomato/flower4.jpg" alt="image small"> </a>
		                        <a class="image-tile">
		                        <img class="s300x300" src="theme/assets/images/tomato/flower5.jpg" alt="image small"> </a>

                     		</div>
                  		</div>

                  		<div class="tab-pane fade" id="details-g-4" role="tabpanel" aria-labelledby="tab-g-4">
                  		...
                  		<div class="tab-pane fade" id="details-g-5" role="tabpanel" aria-labelledby="tab-g-5">
		                      ...
		                      <a  class="image-tile">
		                        <img class="s300x300" src="theme/assets/images/tomato/seed4.jpg" alt="image small"> </a>
		                      <a  class="image-tile">
		                        <img class="s300x300" src="theme/assets/images/tomato/seed5.jpg" alt="image small"> </a>
